Hooks:PostHook( AssetsTweakData, "_init_assets", "new_ecl_assets", function(self, tweak_data)
	...
	self.eclipse_turret_virus = {}
	self.eclipse_turret_virus.visible_if_locked = true
	self.eclipse_turret_virus.name_id = "eclipse_turret_virus_name"
	self.eclipse_turret_virus.unlock_desc_id = "eclipse_turret_virus_desc"
	self.eclipse_turret_virus.texture = "guis/custom_asset/turret_virus"
	self.eclipse_turret_virus.no_mystery = true
	self.eclipse_turret_virus.money_lock = tweak_data:get_value("money_manager", "mission_asset_cost_small", 7)
	self.eclipse_turret_virus.stages = {
		"the_factory"
	}
	self.eclipse_turret_virus.upgrade_lock = {
	upgrade = "additional_assets",
	category = "player"
	}
	if Global.game_settings and Global.game_settings.one_down then
			self.eclipse_medical_room.upgrade_lock = {
